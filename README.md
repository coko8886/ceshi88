...
```
npm create cloudflare@latest -- --template=cloudflare/templates/ceshi88
```

A live public deployment of this template is available at [https://ceshi88.templates.workers.dev](https://ceshi88.templates.workers.dev)
